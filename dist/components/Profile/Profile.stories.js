...
react_1.storiesOf('Profile', module)
    ...
    React.createElement(Profile_1.Profile, { address: "0xdeadbeef", avatar: avatar }))); })
    .add('Image only', function () { return (React.createElement(React.Fragment, null,
    React.createElement(Profile_1.Profile, { address: "0xdeadbeef", avatar: avatar, imageOnly: true }))); })
    .add('Text only', function () { return (React.createElement(React.Fragment, null,
    React.createElement(Profile_1.Profile, { address: "0xdeadbeef", avatar: avatar, textOnly: true }))); })
    .add('Inline', function () { return (React.createElement(React.Fragment, null,
    "You sent ",
    React.createElement(Mana_1.Mana, { inline: true }, "1,000"),
    " to",
    ' ',
    React.createElement(Profile_1.Profile, { address: "0xdeadbeef", avatar: avatar, inline: true }))); })
    .add('Decentraland', function () { return (React.createElement(React.Fragment, null,
    "You sent ",
    React.createElement(Mana_1.Mana, { inline: true }, "1,000"),
    " to",
    ' ',
    React.createElement(Profile_1.Profile, { address: "0xdeadbeef", avatar: avatar, inline: true, isDecentraland: true }))); })
    .add('Sizes', function () { return (React.createElement(React.Fragment, null,
    React.createElement(Profile_1.Profile, { address: "0xdeadbeef", avatar: avatar, inline: false, size: "normal", imageOnly: true }),
    React.createElement(Profile_1.Profile, { address: "0xdeadbeef", avatar: avatar, inline: false, size: "large", imageOnly: true }),
    React.createElement(Profile_1.Profile, { address: "0xdeadbeef", avatar: avatar, inline: false, size: "huge", imageOnly: true }),
    React.createElement(Profile_1.Profile, { address: "0xdeadbeef", avatar: avatar, inline: false, size: "massive", imageOnly: true }),
    React.createElement(Profile_1.Profile, { address: "0xdeadbeef", avatar: avatar, inline: false, size: "normal", imageOnly: true, isDecentraland: true }),
    React.createElement(Profile_1.Profile, { address: "0xdeadbeef", avatar: avatar, inline: false, size: "large", imageOnly: true, isDecentraland: true }),
    React.createElement(Profile_1.Profile, { address: "0xdeadbeef", avatar: avatar, inline: false, size: "huge", imageOnly: true, isDecentraland: true }),
    React.createElement(Profile_1.Profile, { address: "0xdeadbeef", avatar: avatar, inline: false, size: "massive", imageOnly: true, isDecentraland: true }),
